    ...
    <View style={styles.viewBody}>
      {restaurants ? (
        ...
        <View style={styles.loaderRestaurants}>
          ...
          <Text style={{ textAlign: "center" }}>Cargando artículos</Text>
        </View>
      )}
      <Toast ref={toastRef} position="center" opacity={0.9} />
      <Loading text="Eliinando artículo" isVisible={isLoading} />
    </View>
  );
}
...
function Restaurant(props) {
  ...
  const confirmRemoveFavorite = () => {
    Alert.alert(
      ...
      "¿Estas seguro de que quieres eliminar el artículo de favoritos?",
      [
        {
          text: "Cancelar",
          style: "cancel",
